...
public class JogoTests
{
    ...
    public void Construtor_ComDadosValidos_DeveCriarProdutoCorretamente()
    {
        ...
        // Act
        var produto = new Jogo(id, nome, descricao, categoria, preco, dataLancamento);
    ...
    public void Construtor_ComIdVazio_DeveLancarArgumentException()
    {
        ...
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.Empty, "Produto Teste", "Descrição válida do produto", "Categoria", 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComNomeNulo_DeveLancarArgumentException()
    {
        // Arrange & Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), null, "Descrição válida do produto", "Categoria", 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComNomeVazio_DeveLancarArgumentException()
    {
        // Arrange & Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "", "Descrição válida do produto", "Categoria", 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComNomeComMenos3Caracteres_DeveLancarArgumentException()
    {
        // Arrange & Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Ab", "Descrição válida do produto", "Categoria", 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComNomeCom201Caracteres_DeveLancarArgumentException()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), nomeGrande, "Descrição válida do produto", "Categoria", 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComNomeCom200Caracteres_DeveAceitar()
    {
        ...
        // Act
        var produto = new Jogo(Guid.NewGuid(), nome, "Descrição válida do produto", "Categoria", 100m, DateTime.UtcNow);
    ...
    public void Construtor_ComDescricaoNula_DeveLancarArgumentException()
    {
        // Arrange & Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Produto", null, "Categoria", 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComDescricaoComMenos10Caracteres_DeveLancarArgumentException()
    {
        // Arrange & Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Produto", "Desc", "Categoria", 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComDescricaoCom1001Caracteres_DeveLancarArgumentException()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Produto", descricaoGrande, "Categoria", 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComCategoriaNula_DeveLancarArgumentException()
    {
        // Arrange & Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Produto", "Descrição válida", null, 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComCategoriaComMenos3Caracteres_DeveLancarArgumentException()
    {
        // Arrange & Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Produto", "Descrição válida", "Ab", 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComCategoriaCom51Caracteres_DeveLancarArgumentException()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Produto", "Descrição válida", categoriaGrande, 100m, DateTime.UtcNow));
    ...
    public void Construtor_ComPrecoZero_DeveLancarArgumentException()
    {
        // Arrange & Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Produto", "Descrição válida", "Categoria", 0m, DateTime.UtcNow));
    ...
    public void Construtor_ComPrecoNegativo_DeveLancarArgumentException()
    {
        // Arrange & Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Produto", "Descrição válida", "Categoria", -10m, DateTime.UtcNow));
    ...
    public void Construtor_ComPrecoMuitoAlto_DeveLancarArgumentException()
    {
        // Arrange & Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Produto", "Descrição válida", "Categoria", 1000000m, DateTime.UtcNow));
    ...
    public void Construtor_ComDataMuitoAntiga_DeveLancarArgumentException()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() =>
            new Jogo(Guid.NewGuid(), "Produto", "Descrição válida", "Categoria", 100m, dataAntiga));
    ...
    {
        // Arrange
        var produto = new Jogo(Guid.NewGuid(), "Produto", "Descrição original", "Categoria", 100m, DateTime.UtcNow);
    ...
    {
        // Arrange
        var produto = new Jogo(Guid.NewGuid(), "Produto", "Descrição com 10 caracteres", "Categoria", 100m, DateTime.UtcNow);
    ...
    {
        // Arrange
        var produto = new Jogo(Guid.NewGuid(), "Produto", "Descrição com 10 caracteres", "Categoria", 100m, DateTime.UtcNow.AddDays(-1));
    ...
    {
        // Arrange
        var produto = new Jogo(Guid.NewGuid(), "Produto Teste", "Descrição com 10 caracteres", "Eletrônicos", 299.99m, DateTime.UtcNow);
